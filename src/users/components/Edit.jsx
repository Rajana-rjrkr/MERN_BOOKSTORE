            ...
            <div className="bg-white h-full w-90 z-50 fixed top-0 left-0">
              ...
              <div className="flex justify-center items-center flex-col my-5">
                ...
                <div className="flex justify-end w-full px-5 mt-10">
                  ...
                  <button onClick={handleUpdate} className="bg-green-600 ms-3 text-white rounded border py-3 px-4 hover:text-green-600 hover:border-green-600 hover:bg-white">Update</button>
                </div>
              </div>
            </div>
          </div>
