    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 px-10">
        ...
        <div className="flex justify-center items-center gap-2">
          <FontAwesomeIcon style={{ borderRadius: "50%" }} icon={faLocationDot} className="text-2xl  bg-gray-300 p-3 text-gray-700" />
          <p>123 Main Street, Apt 4B,<br /> Anytown, CA 91234</p>
        </div>

        {/* Phone */}
        <div className="flex justify-center items-center gap-2">
          <FontAwesomeIcon style={{ borderRadius: "50%" }} icon={faPhone} className="text-2xl bg-gray-300 p-3 text-gray-700" />
          <p>+91 9874561230</p>
        </div>

        {/* Email */}
        <div className="flex justify-center items-center gap-2">
          <FontAwesomeIcon style={{ borderRadius: "50%" }} icon={faEnvelope} className="text-2xl bg-gray-300 p-3 text-gray-700" />
